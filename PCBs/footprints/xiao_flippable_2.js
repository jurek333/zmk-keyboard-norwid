module.exports = {
  ...
  (footprint "xiao-ble" (layer "F.Cu")
    ...
    (pad "1" smd custom (at -18.12 -13.716 ${p.rot}) (size 1.2 0.5) (layers "F.Cu" "F.Mask")
      ...
      (primitives
        (gr_poly
          ...
          (width 0) (fill yes))
      ) (tstamp 5e1f030a-3b18-401e-8a68-14595a68b0c3) ${p.side == "B"? p.P0.str : p.VCC5.str})
    (pad "1" smd custom (at -18.12 -9.652 ${p.rot}) (size 0.25 0.25) (layers "F.Cu")
      ...
      ) (tstamp 2efc83f4-285f-47ce-adf6-e792a114f64b) ${p.side == "B"? p.P0.str : p.VCC5.str})
    (pad "1" smd custom (at -18.12 -9.652 ${p.rot}) (size 0.25 0.25) (layers "B.Cu")
      ...
      ) (tstamp e640228f-f683-4383-a092-1dd93116f7da) ${p.side == "B"? p.P0.str : p.VCC5.str})
    (pad "1" thru_hole circle (at -18.12 -9.652 ${p.rot + 180}) (size 0.8 0.8) (drill 0.4) (layers "*.Cu") (tstamp effd7922-1191-437a-9ad5-2241b3cbd401) ${p.side == "B"? p.P0.str : p.VCC5.str})
    (pad "1" smd custom (at -18.12 -4.064 ${p.rot + 180}) (size 1.2 0.5) (layers "B.Cu" "B.Mask") ${p.side == "B"? p.P0.str : p.VCC5.str}
      (clearance 0.1) (zone_connect 0)
      (options (clearance outline) (anchor rect))
      (primitives
        (gr_poly
    ...
    (pad "2" smd custom (at -15.58 -13.716 ${p.rot}) (size 1.2 0.5) (layers "F.Cu" "F.Mask")
      ...
      (primitives
        (gr_poly
          ...
          (width 0) (fill yes))
      ) (tstamp 0e1dafa7-5e42-4b14-a03e-183b7d3ebfa3) ${p.side == "B"? p.P1.str : p.GND.str})
    (pad "2" smd custom (at -15.58 -9.652 ${p.rot}) (size 0.25 0.25) (layers "F.Cu")
      ...
      (primitives
        ...
        (gr_line (start 0.766 -0.766) (end 0.766 -3.298) (width 0.25))
        (gr_line (start 0.766 -3.298) (end 0 -4.064) (width 0.25))
      ) (tstamp 24c15d5d-f560-49ac-9065-f3b39fc2dc44) ${p.side == "B"? p.P1.str : p.GND.str})
    (pad "2" smd custom (at -15.58 -9.652 ${p.rot}) (size 0.25 0.25) (layers "B.Cu")
      ...
      (primitives
        ...
        (gr_line (start -0.766 0.766) (end -0.766 4.822) (width 0.25))
        (gr_line (start -0.766 4.822) (end 0 5.588) (width 0.25))
      ) (tstamp 27f6d5de-58fb-4540-b826-698a9cf3177d) ${p.side == "B"? p.P1.str : p.GND.str})
    (pad "2" thru_hole circle (at -15.58 -9.652 ${p.rot + 180}) (size 0.8 0.8) (drill 0.4) (layers "*.Cu") (tstamp 86ddba8f-bdbc-4199-a5d3-72a1aff17748) ${p.side == "B"? p.P1.str : p.GND.str})
    (pad "2" smd custom (at -15.58 -4.064 ${p.rot + 180}) (size 1.2 0.5) (layers "B.Cu" "B.Mask") ${p.side == "B"? p.P1.str : p.GND.str}
      (clearance 0.1) (zone_connect 0)
      (options (clearance outline) (anchor rect))
      (primitives
        (gr_poly
    ...
    (pad "3" smd custom (at -13.04 -13.716 ${p.rot}) (size 1.2 0.5) (layers "F.Cu" "F.Mask")
      ...
      (primitives
        (gr_poly
          ...
          (width 0) (fill yes))
      ) (tstamp 6a09b99f-ee36-4d4c-aaa4-823605c643c7) ${p.side == "B"? p.P2.str : p.VCC3.str})
    (pad "3" smd custom (at -13.04 -9.652 ${p.rot}) (size 0.25 0.25) (layers "F.Cu")
      ...
      (primitives
        ...
        (gr_line (start 0.766 -0.766) (end 0.766 -3.298) (width 0.25))
        (gr_line (start 0.766 -3.298) (end 0 -4.064) (width 0.25))
      ) (tstamp 336fe033-9d06-4e6e-b30d-76e2b29c6977) ${p.side == "B"? p.P2.str : p.VCC3.str})
    (pad "3" smd custom (at -13.04 -9.652 ${p.rot}) (size 0.25 0.25) (layers "B.Cu")
      ...
      (primitives
        ...
        (gr_line (start -0.766 0.766) (end -0.766 4.822) (width 0.25))
        (gr_line (start -0.766 4.822) (end 0 5.588) (width 0.25))
      ) (tstamp d97f5ce2-264e-4723-90d9-3b1770a77486) ${p.side == "B"? p.P2.str : p.VCC3.str})
    (pad "3" thru_hole circle (at -13.04 -9.652 ${p.rot + 180}) (size 0.8 0.8) (drill 0.4) (layers "*.Cu") (tstamp 1471df66-5ff7-4a36-a993-ba6c2063ea4c) ${p.side == "B"? p.P2.str : p.VCC3.str})
    (pad "3" smd custom (at -13.04 -4.064 ${p.rot + 180}) (size 1.2 0.5) (layers "B.Cu" "B.Mask") ${p.side == "B"? p.P2.str : p.VCC3.str}
      (clearance 0.1) (zone_connect 0)
      (options (clearance outline) (anchor rect))
      (primitives
        (gr_poly
    ...
    (pad "4" smd custom (at -10.5 -13.716 ${p.rot}) (size 1.2 0.5) (layers "F.Cu" "F.Mask")
      ...
      (primitives
        (gr_poly
          ...
          (width 0) (fill yes))
      ) (tstamp d3cbba1d-0fcb-4266-91c3-6b4e461465ef) ${p.side == "B"? p.P3.str : p.P10.str})
    (pad "4" smd custom (at -10.5 -9.652 ${p.rot}) (size 0.25 0.25) (layers "F.Cu")
      ...
      (primitives
        ...
        (gr_line (start 0.766 -0.766) (end 0.766 -3.298) (width 0.25))
        (gr_line (start 0.766 -3.298) (end 0 -4.064) (width 0.25))
      ) (tstamp acbe51a9-9f68-4090-a06b-db4fc83d1d42) ${p.side == "B"? p.P3.str : p.P10.str})
    (pad "4" smd custom (at -10.5 -9.652 ${p.rot}) (size 0.25 0.25) (layers "B.Cu")
      ...
      (primitives
        ...
        (gr_line (start -0.766 0.766) (end -0.766 4.822) (width 0.25))
        (gr_line (start -0.766 4.822) (end 0 5.588) (width 0.25))
      ) (tstamp 42a5335a-7f70-4a93-8916-8bdc7efb086b) ${p.side == "B"? p.P3.str : p.P10.str})
    (pad "4" thru_hole circle (at -10.5 -9.652 ${p.rot + 180}) (size 0.8 0.8) (drill 0.4) (layers "*.Cu") (tstamp 0e229b9b-4845-4dee-9cfd-76abcb7712b0) ${p.side == "B"? p.P3.str : p.P10.str})
    (pad "4" smd custom (at -10.5 -4.064 ${p.rot + 180}) (size 1.2 0.5) (layers "B.Cu" "B.Mask") ${p.side == "B"? p.P3.str : p.P10.str}
      (clearance 0.1) (zone_connect 0)
      (options (clearance outline) (anchor rect))
      (primitives
        (gr_poly
    ...
    (pad "5" smd custom (at -7.96 -13.716 ${p.rot}) (size 1.2 0.5) (layers "F.Cu" "F.Mask")
      ...
      (primitives
        (gr_poly
          ...
          (width 0) (fill yes))
      ) (tstamp 35e3ace4-5fe0-43ab-9eb9-b2e8a836f6bc) ${p.side == "B"? p.P4.str : p.P9.str})
    (pad "5" smd custom (at -7.96 -9.652 ${p.rot}) (size 0.25 0.25) (layers "F.Cu")
      ...
      (primitives
        ...
        (gr_line (start 0.766 -0.766) (end 0.766 -3.298) (width 0.25))
        (gr_line (start 0.766 -3.298) (end 0 -4.064) (width 0.25))
      ) (tstamp 114d8172-8a19-4db6-9346-24f675a68693) ${p.side == "B"? p.P4.str : p.P9.str})
    (pad "5" smd custom (at -7.96 -9.652 ${p.rot}) (size 0.25 0.25) (layers "B.Cu")
      ...
      (primitives
        ...
        (gr_line (start -0.766 0.766) (end -0.766 4.822) (width 0.25))
        (gr_line (start -0.766 4.822) (end 0 5.588) (width 0.25))
      ) (tstamp eecc3a37-e8c0-4c56-9d2f-28d69fdbd8b9) ${p.side == "B"? p.P4.str : p.P9.str})
    (pad "5" thru_hole circle (at -7.96 -9.652 ${p.rot + 180}) (size 0.8 0.8) (drill 0.4) (layers "*.Cu") (tstamp 346eaf32-1de4-46f2-bfac-9a74a681dd59) ${p.side == "B"? p.P4.str : p.P9.str})
    (pad "5" smd custom (at -7.96 -4.064 ${p.rot + 180}) (size 1.2 0.5) (layers "B.Cu" "B.Mask") ${p.side == "B"? p.P4.str : p.P9.str}
      (clearance 0.1) (zone_connect 0)
      (options (clearance outline) (anchor rect))
      (primitives
        (gr_poly
    ...
    (pad "6" smd custom (at -5.42 -13.716 ${p.rot}) (size 1.2 0.5) (layers "F.Cu" "F.Mask")
      ...
      (primitives
        (gr_poly
          ...
          (width 0) (fill yes))
      ) (tstamp 17456729-089c-4d80-927c-6fa6d7f8305e) ${p.side == "B"? p.P5.str : p.P8.str})
    (pad "6" smd custom (at -5.42 -9.652 ${p.rot}) (size 0.25 0.25) (layers "F.Cu")
      ...
      (primitives
        ...
        (gr_line (start 0.766 -0.766) (end 0.766 -3.298) (width 0.25))
        (gr_line (start 0.766 -3.298) (end 0 -4.064) (width 0.25))
      ) (tstamp 73039b20-b2bb-48af-b3e8-15c9caaab0ba) ${p.side == "B"? p.P5.str : p.P8.str})
    (pad "6" smd custom (at -5.42 -9.652 ${p.rot}) (size 0.25 0.25) (layers "B.Cu")
      ...
      (primitives
        ...
        (gr_line (start -0.766 0.766) (end -0.766 4.822) (width 0.25))
        (gr_line (start -0.766 4.822) (end 0 5.588) (width 0.25))
      ) (tstamp 42e64d66-b6a9-42e3-88ab-bc3a38e58409) ${p.side == "B"? p.P5.str : p.P8.str})
    (pad "6" thru_hole circle (at -5.42 -9.652 ${p.rot + 180}) (size 0.8 0.8) (drill 0.4) (layers "*.Cu") (tstamp 05fb03b7-9dbf-4f4f-b766-fd0b534ed10d) ${p.side == "B"? p.P5.str : p.P8.str})
    (pad "6" smd custom (at -5.42 -4.064 ${p.rot + 180}) (size 1.2 0.5) (layers "B.Cu" "B.Mask") ${p.side == "B"? p.P5.str : p.P8.str}
      (clearance 0.1) (zone_connect 0)
      (options (clearance outline) (anchor rect))
      (primitives
        (gr_poly
    ...
    (pad "7" smd custom (at -2.88 -13.716 ${p.rot}) (size 1.2 0.5) (layers "F.Cu" "F.Mask")
      ...
      (primitives
        (gr_poly
          ...
          (width 0) (fill yes))
      ) (tstamp 694825bf-448a-476a-8960-814e9b70c9f3) ${p.side == "B"? p.P6.str : p.P7.str})
    (pad "7" smd custom (at -2.88 -9.652 ${p.rot}) (size 0.25 0.25) (layers "F.Cu")
      ...
      (primitives
        ...
        (gr_line (start 0.766 -0.766) (end 0.766 -3.298) (width 0.25))
        (gr_line (start 0.766 -3.298) (end 0 -4.064) (width 0.25))
      ) (tstamp 172160fa-a95e-47c4-a20e-3457cded091c) ${p.side == "B"? p.P6.str : p.P7.str})
    (pad "7" smd custom (at -2.88 -9.652 ${p.rot}) (size 0.25 0.25) (layers "B.Cu")
      ...
      (primitives
        ...
        (gr_line (start -0.766 0.766) (end -0.766 4.822) (width 0.25))
        (gr_line (start -0.766 4.822) (end 0 5.588) (width 0.25))
      ) (tstamp 777d1c82-5f2d-48be-8cc2-b72602479035) ${p.side == "B"? p.P6.str : p.P7.str})
    (pad "7" thru_hole circle (at -2.88 -9.652 ${p.rot + 180}) (size 0.8 0.8) (drill 0.4) (layers "*.Cu") (tstamp c69be33f-8776-4bdd-8608-791fbaa6b84a) ${p.side == "B"? p.P6.str : p.P7.str})
    (pad "7" smd custom (at -2.88 -4.064 ${p.rot + 180}) (size 1.2 0.5) (layers "B.Cu" "B.Mask") ${p.side == "B"? p.P6.str : p.P7.str}
      (clearance 0.1) (zone_connect 0)
      (options (clearance outline) (anchor rect))
      (primitives
        (gr_poly
    ...
    (pad "18" smd custom (at -2.88 -13.716 ${p.rot}) (size 1.2 0.5) (layers "B.Cu" "B.Mask")
      ...
      (primitives
        (gr_poly
          ...
          (width 0) (fill yes))
      ) (tstamp 0fd425fa-8963-4f21-9a1f-0bf3446bf215) ${p.side == "B"? p.P7.str : p.P6.str})
    (pad "18" smd custom (at -2.88 -8.128 ${p.rot + 180}) (size 0.25 0.25) (layers "F.Cu")
      ...
      ) (tstamp 2655209b-86bc-4b8b-b5d4-cba2d9bfe9a4) ${p.side == "B"? p.P7.str : p.P6.str})
    (pad "18" smd custom (at -2.88 -8.128 ${p.rot + 180}) (size 0.25 0.25) (layers "B.Cu")
      ...
      (primitives
        ...
        (gr_line (start -0.766 0.766) (end -0.766 4.822) (width 0.25))
        (gr_line (start -0.766 4.822) (end 0 5.588) (width 0.25))
      ) (tstamp fd3bf8d1-eb00-451b-89d0-56484f5c866c) ${p.side == "B"? p.P7.str : p.P6.str})
    (pad "18" thru_hole circle (at -2.88 -8.128 ${p.rot + 180}) (size 0.8 0.8) (drill 0.4) (layers "*.Cu") (tstamp a17c56a7-5e49-4b45-84b3-1bf64f7c449e) ${p.side == "B"? p.P7.str : p.P6.str})
    (pad "18" smd custom (at -2.88 -4.064 ${p.rot + 180}) (size 1.2 0.5) (layers "F.Cu" "F.Mask") ${p.side == "B"? p.P7.str : p.P6.str}
      (clearance 0.1) (zone_connect 0)
      (options (clearance outline) (anchor rect))
      (primitives
        (gr_poly
    ...
    (pad "19" smd custom (at -5.42 -13.716 ${p.rot}) (size 1.2 0.5) (layers "B.Cu" "B.Mask")
      ...
      (primitives
        (gr_poly
          ...
          (width 0) (fill yes))
      ) (tstamp d9f2a549-2e01-44d2-a846-d7252fa4da39) ${p.side == "B"? p.P8.str : p.P5.str})
    (pad "19" smd custom (at -5.42 -8.128 ${p.rot + 180}) (size 0.25 0.25) (layers "F.Cu")
      ...
      (primitives
        ...
        (gr_line (start 0.762 -0.762) (end 0.762 -3.302) (width 0.25))
        (gr_line (start 0.762 -3.302) (end 0 -4.064) (width 0.25))
      ) (tstamp ba4401d7-3645-439b-a08e-b63e7f29811c) ${p.side == "B"? p.P8.str : p.P5.str})
    (pad "19" smd custom (at -5.42 -8.128 ${p.rot + 180}) (size 0.25 0.25) (layers "B.Cu")
      ...
      (primitives
        ...
        (gr_line (start -0.766 0.766) (end -0.766 4.822) (width 0.25))
        (gr_line (start -0.766 4.822) (end 0 5.588) (width 0.25))
      ) (tstamp 0008dbfc-4a62-4e72-99a2-adf28713b46d) ${p.side == "B"? p.P8.str : p.P5.str})
    (pad "19" thru_hole circle (at -5.42 -8.128 ${p.rot + 180}) (size 0.8 0.8) (drill 0.4) (layers "*.Cu") (tstamp 2023ccd8-3864-4668-85f1-71a3b2de48fc) ${p.side == "B"? p.P8.str : p.P5.str})
    (pad "19" smd custom (at -5.42 -4.064 ${p.rot + 180}) (size 1.2 0.5) (layers "F.Cu" "F.Mask") ${p.side == "B"? p.P8.str : p.P5.str}
      (clearance 0.1) (zone_connect 0)
      (options (clearance outline) (anchor rect))
      (primitives
        (gr_poly
    ...
    (pad "20" smd custom (at -7.96 -13.716 ${p.rot}) (size 1.2 0.5) (layers "B.Cu" "B.Mask")
      ...
      (primitives
        (gr_poly
          ...
          (width 0) (fill yes))
      ) (tstamp 1f983efb-f8d1-480e-b284-ea3ad7fc1b50) ${p.side == "B"? p.P9.str : p.P4.str})
    (pad "20" smd custom (at -7.96 -8.128 ${p.rot + 180}) (size 0.25 0.25) (layers "F.Cu")
      ...
      (primitives
        ...
        (gr_line (start 0.762 -0.762) (end 0.762 -3.302) (width 0.25))
        (gr_line (start 0.762 -3.302) (end 0 -4.064) (width 0.25))
      ) (tstamp 0dafc189-b4f8-490a-ab75-2403420ae1f2) ${p.side == "B"? p.P9.str : p.P4.str})
    (pad "20" smd custom (at -7.96 -8.128 ${p.rot + 180}) (size 0.25 0.25) (layers "B.Cu")
      ...
      (primitives
        ...
        (gr_line (start -0.766 0.766) (end -0.766 4.822) (width 0.25))
        (gr_line (start -0.766 4.822) (end 0 5.588) (width 0.25))
      ) (tstamp 2580a042-d109-4f47-ac5f-474f8d70251d) ${p.side == "B"? p.P9.str : p.P4.str})
    (pad "20" thru_hole circle (at -7.96 -8.128 ${p.rot + 180}) (size 0.8 0.8) (drill 0.4) (layers "*.Cu") (tstamp 5ff76348-2d4f-4ce5-ac71-86b629c3b535) ${p.side == "B"? p.P9.str : p.P4.str})
    (pad "20" smd custom (at -7.96 -4.064 ${p.rot + 180}) (size 1.2 0.5) (layers "F.Cu" "F.Mask") ${p.side == "B"? p.P9.str : p.P4.str}
      (clearance 0.1) (zone_connect 0)
      (options (clearance outline) (anchor rect))
      (primitives
        (gr_poly
    ...
    (pad "21" smd custom (at -10.5 -13.716 ${p.rot}) (size 1.2 0.5) (layers "B.Cu" "B.Mask")
      ...
      (primitives
        (gr_poly
          ...
          (width 0) (fill yes))
      ) (tstamp 4678309b-54e2-4635-b92c-93153ae1a28c) ${p.side == "B"? p.P10.str : p.P3.str})
    (pad "21" smd custom (at -10.5 -8.128 ${p.rot + 180}) (size 0.25 0.25) (layers "F.Cu")
      ...
      (primitives
        ...
        (gr_line (start 0.762 -0.762) (end 0.762 -3.302) (width 0.25))
        (gr_line (start 0.762 -3.302) (end 0 -4.064) (width 0.25))
      ) (tstamp 639cc50c-1820-46ba-9def-9a4688f631ef) ${p.side == "B"? p.P10.str : p.P3.str})
    (pad "21" smd custom (at -10.5 -8.128 ${p.rot + 180}) (size 0.25 0.25) (layers "B.Cu")
      ...
      (primitives
        ...
        (gr_line (start -0.766 0.766) (end -0.766 4.822) (width 0.25))
        (gr_line (start -0.766 4.822) (end 0 5.588) (width 0.25))
      ) (tstamp c9fcee45-a47b-41d7-ae01-a78c33ac04bf) ${p.side == "B"? p.P10.str : p.P3.str})
    (pad "21" thru_hole circle (at -10.5 -8.128 ${p.rot + 180}) (size 0.8 0.8) (drill 0.4) (layers "*.Cu") (tstamp 1482796b-e3f4-4413-a0b5-6d4d3eb3999f) ${p.side == "B"? p.P10.str : p.P3.str})
    (pad "21" smd custom (at -10.5 -4.064 ${p.rot + 180}) (size 1.2 0.5) (layers "F.Cu" "F.Mask") ${p.side == "B"? p.P10.str : p.P3.str}
      (clearance 0.1) (zone_connect 0)
      (options (clearance outline) (anchor rect))
      (primitives
        (gr_poly
    ...
    (pad "22" smd custom (at -13.04 -13.716 ${p.rot}) (size 1.2 0.5) (layers "B.Cu" "B.Mask")
      ...
      (primitives
        (gr_poly
          ...
          (width 0) (fill yes))
      ) (tstamp 2bc4bdac-df6f-4cdb-9f98-f7368392c1d9) ${p.side == "B"? p.VCC3.str : p.P2.str})
    (pad "22" smd custom (at -13.04 -8.128 ${p.rot + 180}) (size 0.25 0.25) (layers "F.Cu")
      ...
      (primitives
        ...
        (gr_line (start 0.762 -0.762) (end 0.762 -3.302) (width 0.25))
        (gr_line (start 0.762 -3.302) (end 0 -4.064) (width 0.25))
      ) (tstamp c278ab92-5edb-4226-ba7f-47f342e3592d) ${p.side == "B"? p.VCC3.str : p.P2.str})
    (pad "22" smd custom (at -13.04 -8.128 ${p.rot + 180}) (size 0.25 0.25) (layers "B.Cu")
      ...
      (primitives
        ...
        (gr_line (start -0.766 0.766) (end -0.766 4.822) (width 0.25))
        (gr_line (start -0.766 4.822) (end 0 5.588) (width 0.25))
      ) (tstamp 3fcf8b8b-b0e5-4846-9520-68386634abde) ${p.side == "B"? p.VCC3.str : p.P2.str})
    (pad "22" thru_hole circle (at -13.04 -8.128 ${p.rot + 180}) (size 0.8 0.8) (drill 0.4) (layers "*.Cu") (tstamp 6658e748-0025-498d-887d-d3d29c38d08e) ${p.side == "B"? p.VCC3.str : p.P2.str})
    (pad "22" smd custom (at -13.04 -4.064 ${p.rot + 180}) (size 1.2 0.5) (layers "F.Cu" "F.Mask") ${p.side == "B"? p.VCC3.str : p.P2.str}
      (clearance 0.1) (zone_connect 0)
      (options (clearance outline) (anchor rect))
      (primitives
        (gr_poly
    ...
    (pad "23" smd custom (at -15.58 -13.716 ${p.rot}) (size 1.2 0.5) (layers "B.Cu" "B.Mask")
      ...
      (primitives
        (gr_poly
          ...
          (width 0) (fill yes))
      ) (tstamp decfd3df-9ad9-4e18-be1f-625cbae81ddd) ${p.side == "B"? p.GND.str : p.P1.str})
    (pad "23" smd custom (at -15.58 -8.128 ${p.rot + 180}) (size 0.25 0.25) (layers "F.Cu")
      ...
      (primitives
        ...
        (gr_line (start 0.762 -0.762) (end 0.762 -3.302) (width 0.25))
        (gr_line (start 0.762 -3.302) (end 0 -4.064) (width 0.25))
      ) (tstamp 0626e9e9-9179-44ef-a771-f9b4460b2a13) ${p.side == "B"? p.GND.str : p.P1.str})
    (pad "23" smd custom (at -15.58 -8.128 ${p.rot + 180}) (size 0.25 0.25) (layers "B.Cu")
      ...
      (primitives
        ...
        (gr_line (start -0.766 0.766) (end -0.766 4.822) (width 0.25))
        (gr_line (start -0.766 4.822) (end 0 5.588) (width 0.25))
      ) (tstamp c9d1d6ce-6cb2-4403-aea7-0ec475ee08bb) ${p.side == "B"? p.GND.str : p.P1.str})
    (pad "23" thru_hole circle (at -15.58 -8.128 ${p.rot + 180}) (size 0.8 0.8) (drill 0.4) (layers "*.Cu") (tstamp e0313b51-4ab2-4492-a738-eaaab92810a8) ${p.side == "B"? p.GND.str : p.P1.str})
    (pad "23" smd custom (at -15.58 -4.064 ${p.rot + 180}) (size 1.2 0.5) (layers "F.Cu" "F.Mask") ${p.side == "B"? p.GND.str : p.P1.str}
      (clearance 0.1) (zone_connect 0)
      (options (clearance outline) (anchor rect))
      (primitives
        (gr_poly
    ...
    (pad "24" smd custom (at -18.12 -13.716 ${p.rot}) (size 1.2 0.5) (layers "B.Cu" "B.Mask")
      ...
      (primitives
        (gr_poly
          ...
          (width 0) (fill yes))
      ) (tstamp 4b3add99-03c0-44be-bd91-1cd4500328ed) ${p.side == "B"? p.VCC5.str : p.P0.str})
    (pad "24" smd custom (at -18.12 -8.128 ${p.rot + 180}) (size 0.25 0.25) (layers "F.Cu")
      ...
      (primitives
        ...
        (gr_line (start 0.762 -0.762) (end 0.762 -3.302) (width 0.25))
        (gr_line (start 0.762 -3.302) (end 0 -4.064) (width 0.25))
      ) (tstamp d3a0f701-c1ab-480f-90eb-18819ae7e9d1) ${p.side == "B"? p.VCC5.str : p.P0.str})
    (pad "24" smd custom (at -18.12 -8.128 ${p.rot + 180}) (size 0.25 0.25) (layers "B.Cu")
      ...
      (primitives
        ...
        (gr_line (start -0.766 0.766) (end -0.766 4.822) (width 0.25))
        (gr_line (start -0.766 4.822) (end 0 5.588) (width 0.25))
      ) (tstamp e6130121-e0ce-48a0-b20a-e279bf7a79f9) ${p.side == "B"? p.VCC5.str : p.P0.str})
    (pad "24" thru_hole circle (at -18.12 -8.128 ${p.rot + 180}) (size 0.8 0.8) (drill 0.4) (layers "*.Cu") (tstamp 3b8faa6c-b5e4-438c-a03d-5f17ad67b089) ${p.side == "B"? p.VCC5.str : p.P0.str})
    (pad "24" smd custom (at -18.12 -4.064 ${p.rot + 180}) (size 1.2 0.5) (layers "F.Cu" "F.Mask") ${p.side == "B"? p.VCC5.str : p.P0.str}
      (clearance 0.1) (zone_connect 0)
      (options (clearance outline) (anchor rect))
      (primitives
        (gr_poly
